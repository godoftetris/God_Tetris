...
int tetris()
{
    ...
    Texture t1,t2,t3;
    t1.loadFromFile("../God_Tetris/app/images/tiles.png");
    t2.loadFromFile("../God_Tetris/app/images/background.png");
    t3.loadFromFile("../God_Tetris/app/images/frame.png");
